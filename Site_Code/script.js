...
createProjectMainCard("Grid-Tab-2", "Cyber Discovery Bot", "The bot for the Cyber Discovery Community Discord Server. It has a variety of important and fun features. For example, it can get the briefing for a CyberStart Assess Level, or fetch an XKCD. Relax, take a load off and join our discord. Invite link in menu.", "cdbotmain_card_image", "https://github.com/CyberDiscovery/cyberdisc-bot", "https://github.com/login?return_to=%2FCyberDiscovery%2Fcyberdisc-bot", "https://github.com/CyberDiscovery/cyberdisc-bot/issues", "Server Invite", "http://discord.gg/Kf8n5rT", "exit_to_app");
...
createLinkCard("Grid-Tab-4", "Alexa Skill", "We made an Alexa skill which you can try out on your Echo device today! The unofficial Cyber Discovery Buddy helps by giving you tips for stages and by giving you start and end dates for challenges!", "alexa_skill_card_image", "https://amzn.to/2FZ9wSc");
